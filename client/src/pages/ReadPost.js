  ...
  return (
    <>
      ...
      <OuterDiv>
        <PostSectionDiv>
          <TitleBoxDiv>
            <TitleDiv>{props.nowPost.title}</TitleDiv>
            <NicknameSpan>{props.nowPost.nickname}</NicknameSpan>
            <TimeSpan>{props.nowPost.date}</TimeSpan>
          </TitleBoxDiv>
          <ContentTextarea
          ...
          <InformationOuterDiv>
            <InformationBoxDiv>
              ...
              <InformationDiv>{props.nowPost.menu}</InformationDiv>
            </InformationBoxDiv>
            <InformationBoxDiv>
          ...
          <BankAccountOuterDiv>
            ...
            <BankAccountBoxDiv>
              <BankDiv>{props.nowPost.bank_name}은행</BankDiv>
              <AccountDiv>{props.nowPost.account_number}</AccountDiv>
            </BankAccountBoxDiv>
          </BankAccountOuterDiv>
          <MapBoxDiv>
            <MapIndexDiv>배달받을 장소: {props.nowPost.address}</MapIndexDiv>
          ...
          <BottomDiv>
            ...
            ></BottomTextarea>
            <ApplyButton onClick={onClickApplyButton}>신 청 하 기</ApplyButton>
          </BottomDiv>
        </PostSectionDiv>
        <CommentSectionDiv>
